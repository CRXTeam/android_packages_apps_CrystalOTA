...
Crystal over the air updates app


License
-------

CrystalOTA is licensed under the terms of the *GNU General Public License,
...
CrystalOTA allows you to update your Crystal Android ROM and your Google Apps.
...
CrystalOTA needs to be installed in /system/priv-app to achieve the system
